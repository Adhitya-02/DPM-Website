    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="{{ asset('dist/img/logo_KabMadiun.gif') }}" alt="Logo KabMadiun" class="brand-image img-circle elevation-3"
                    style="opacity: .8">
                <span class="brand-text font-weight-light">SIPETA</span>
            </a>
        ...
        <footer class="main-footer">
            <!-- Default to the left -->
            <strong>Copyright &copy; 2025 <a href="https://adminlte.io">SIPETA</a>.</strong> All rights reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
